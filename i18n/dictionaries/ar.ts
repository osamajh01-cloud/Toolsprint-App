...
export const ar: Dictionary = {
  ...
  why: {
    ...
    noUploadBody:
      "بينما ترفع المواقع الأخرى ملفات PDF وصورك لضغطها، ينجز ToolSprint العمل داخل المتصفح نفسه.",
  },
  faq: {
    ...
    items: [
      ...
      {
        q: "ما اللغات التي يدعمها ToolSprint؟",
      ...
      {
        q: "ما الذي يميّز ToolSprint عن الأدوات الأخرى؟",
        a: "معظم المحوّلات الإلكترونية ترفع ملفاتك إلى خوادمها. أما ToolSprint فيعالج كل شيء محلياً في متصفحك، ما يجعله أسرع في معظم المهام وخاصاً بالتصميم.",
      },
    ],
  },
  cta: {
